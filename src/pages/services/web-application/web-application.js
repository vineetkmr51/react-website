...
const WebApplication = () => {
  return (
    <div className="services-page">
      <Helmet>
        <title>Best Web Development Services Company in USA | Radiansys</title>
        <meta property="og:title" content="Web Development Services" />
        <meta
          property="og:description"
          content="Radiansys is a reputed Web Development Services Company in USA. We Offer web design and development in ReactJS, NodeJS, VueJS, MEAN Stack, Java &amp; PHP."
        />
        <meta
          property="og:image"
          content="https://www.radiansys.com/full-stack.png"
        />
        ...
        <link
          rel="canonical"
          href="https://www.radiansys.com/technologies/web-development-services"
        />
        <meta property="og:locale" content="en_US" />
        <meta property="og:type" content="article" />
        <meta
          property="og:url"
          content="https://www.radiansys.com/technologies/web-development-services"
        />
